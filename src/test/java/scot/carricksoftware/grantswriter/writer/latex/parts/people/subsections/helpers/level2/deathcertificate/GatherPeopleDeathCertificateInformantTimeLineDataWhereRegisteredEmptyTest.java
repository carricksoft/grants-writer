...
class GatherPeopleDeathCertificateInformantTimeLineDataWhereRegisteredEmptyTest {

    GatherPeopleDeathCertificateInformantTimeLineData gatherPeopleDeathCertificateInformantTimeLineData;
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleDeathCertificateInformantTimeLineData = new GatherPeopleDeathCertificateInformantTimeLineDataImpl(this.timelineDataMock);
