...
class GatherPeopleBirthCertificateFatherTimeLineDataFatherTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleBirthCertificateFatherTimeLineData = new GatherPeopleBirthCertificateFatherTimeLineDataImpl(this.timelineDataMock);
