...
class GatherPeopleMarriageCertificateSecondWitnessTimeLineDataRefsTest {

    GatherPeopleMarriageCertificateSecondWitnessTimeLineData gatherPeopleMarriageCertificateSecondWitnessTimeLineData;
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleMarriageCertificateSecondWitnessTimeLineData = new GatherPeopleMarriageCertificateSecondWitnessTimeLineDataImpl(
                timelineDataMock,
    ...
    void refsAreAddedTest() {
        ...
        gatherPeopleMarriageCertificateSecondWitnessTimeLineData.gather(marriageCertificates);
