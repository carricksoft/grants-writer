...
@Component
public class GatherPeopleMarriageCertificateBrideTimeLineDataImpl implements GatherPeopleMarriageCertificateBrideTimeLineData {

    private final TimeLineData timelineData;

    private final StringToDMYConverter stringToDMYConverter;

    private static final Logger logger = LogManager.getLogger(GatherPeopleMarriageCertificateBrideTimeLineDataImpl.class);

    public GatherPeopleMarriageCertificateBrideTimeLineDataImpl(TimeLineData timelineData, StringToDMYConverter stringToDMYConverter) {
