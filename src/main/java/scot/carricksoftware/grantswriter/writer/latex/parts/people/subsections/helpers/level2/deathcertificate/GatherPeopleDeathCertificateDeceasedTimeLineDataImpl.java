...
@Component
public class GatherPeopleDeathCertificateDeceasedTimeLineDataImpl implements GatherPeopleDeathCertificateDeceasedTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleDeathCertificateDeceasedTimeLineDataImpl.class);

    public GatherPeopleDeathCertificateDeceasedTimeLineDataImpl(TimeLineData timelineData) {
