...
@Component
public class GatherPeopleBirthCertificateNewBornTimeLineDataImpl implements GatherPeopleBirthCertificateNewBornTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleBirthCertificateNewBornTimeLineDataImpl.class);

    public GatherPeopleBirthCertificateNewBornTimeLineDataImpl(TimeLineData timelineData) {
