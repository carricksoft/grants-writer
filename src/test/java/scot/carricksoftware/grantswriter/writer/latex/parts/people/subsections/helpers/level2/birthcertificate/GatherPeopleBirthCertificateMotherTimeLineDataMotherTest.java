...
class GatherPeopleBirthCertificateMotherTimeLineDataMotherTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleBirthCertificateMotherTimeLineData = new GatherPeopleBirthCertificateMotherTimeLineDataImpl(this.timelineDataMock);
