...
@Component
public class GatherPeopleMarriageCertificateGroomTimeLineDataImpl implements GatherPeopleMarriageCertificateGroomTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleMarriageCertificateGroomTimeLineDataImpl.class);

    private final StringToDMYConverter stringToDMYConverter;

    public GatherPeopleMarriageCertificateGroomTimeLineDataImpl(TimeLineData timelineData, StringToDMYConverter stringToDMYConverter) {
