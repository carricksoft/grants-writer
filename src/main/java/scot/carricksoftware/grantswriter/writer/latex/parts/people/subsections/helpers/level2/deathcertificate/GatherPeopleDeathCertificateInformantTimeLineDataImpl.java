...
@Component
public class GatherPeopleDeathCertificateInformantTimeLineDataImpl implements GatherPeopleDeathCertificateInformantTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleDeathCertificateInformantTimeLineDataImpl.class);

    public GatherPeopleDeathCertificateInformantTimeLineDataImpl(TimeLineData timelineData) {
