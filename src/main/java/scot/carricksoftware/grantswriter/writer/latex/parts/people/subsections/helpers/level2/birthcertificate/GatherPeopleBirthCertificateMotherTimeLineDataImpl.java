...
@Component
public class GatherPeopleBirthCertificateMotherTimeLineDataImpl implements GatherPeopleBirthCertificateMotherTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleBirthCertificateMotherTimeLineDataImpl.class);

    public GatherPeopleBirthCertificateMotherTimeLineDataImpl(TimeLineData timelineData) {
