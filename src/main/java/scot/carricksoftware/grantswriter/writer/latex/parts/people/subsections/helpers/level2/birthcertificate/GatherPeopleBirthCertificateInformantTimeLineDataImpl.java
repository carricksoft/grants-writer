...
@Component
public class GatherPeopleBirthCertificateInformantTimeLineDataImpl implements GatherPeopleBirthCertificateInformantTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleBirthCertificateInformantTimeLineDataImpl.class);

    public GatherPeopleBirthCertificateInformantTimeLineDataImpl(TimeLineData timelineData) {
