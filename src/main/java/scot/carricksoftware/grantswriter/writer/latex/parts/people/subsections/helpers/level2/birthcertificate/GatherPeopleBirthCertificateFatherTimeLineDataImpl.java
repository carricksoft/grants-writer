...
@Component
public class GatherPeopleBirthCertificateFatherTimeLineDataImpl implements GatherPeopleBirthCertificateFatherTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleBirthCertificateFatherTimeLineDataImpl.class);

    public GatherPeopleBirthCertificateFatherTimeLineDataImpl(TimeLineData timelineData) {
