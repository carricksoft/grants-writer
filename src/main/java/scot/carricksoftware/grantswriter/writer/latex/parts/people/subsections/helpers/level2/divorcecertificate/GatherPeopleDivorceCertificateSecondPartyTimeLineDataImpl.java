...
@Component
public class GatherPeopleDivorceCertificateSecondPartyTimeLineDataImpl implements GatherPeopleDivorceCertificateSecondPartyTimeLineData {

    private final TimeLineData timelineData;

    private final StringToDMYConverter stringToDMYConverter;

    private static final Logger logger = LogManager.getLogger(GatherPeopleDivorceCertificateSecondPartyTimeLineDataImpl.class);


    public GatherPeopleDivorceCertificateSecondPartyTimeLineDataImpl(TimeLineData timelineData, StringToDMYConverter stringToDMYConverter) {
