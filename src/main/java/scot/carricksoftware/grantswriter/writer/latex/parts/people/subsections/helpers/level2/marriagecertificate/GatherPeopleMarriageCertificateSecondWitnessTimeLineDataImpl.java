...
@Component
public class GatherPeopleMarriageCertificateSecondWitnessTimeLineDataImpl implements GatherPeopleMarriageCertificateSecondWitnessTimeLineData {

    private final TimeLineData timelineData;

    private static final Logger logger = LogManager.getLogger(GatherPeopleMarriageCertificateSecondWitnessTimeLineDataImpl.class);

    private final AddWitnessDetails addWitnessDetails;

    public GatherPeopleMarriageCertificateSecondWitnessTimeLineDataImpl(TimeLineData timelineData, AddWitnessDetails addWitnessDetails) {
