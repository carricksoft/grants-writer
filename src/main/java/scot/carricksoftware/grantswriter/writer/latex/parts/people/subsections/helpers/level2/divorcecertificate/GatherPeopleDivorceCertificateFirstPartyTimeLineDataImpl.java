...
@Component
public class GatherPeopleDivorceCertificateFirstPartyTimeLineDataImpl implements GatherPeopleDivorceCertificateFirstPartyTimeLineData {

    private final TimeLineData timelineData;

    private final StringToDMYConverter stringToDMYConverter;

    private static final Logger logger = LogManager.getLogger(GatherPeopleDivorceCertificateFirstPartyTimeLineDataImpl.class);

    public GatherPeopleDivorceCertificateFirstPartyTimeLineDataImpl(TimeLineData timelineData, StringToDMYConverter stringToDMYConverter) {
