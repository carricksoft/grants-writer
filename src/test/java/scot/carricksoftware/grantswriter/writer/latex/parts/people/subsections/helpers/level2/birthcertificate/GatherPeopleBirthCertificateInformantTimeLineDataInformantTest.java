...
class GatherPeopleBirthCertificateInformantTimeLineDataInformantTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleBirthCertificateInformantTimeLineData = new GatherPeopleBirthCertificateInformantTimeLineDataImpl(this.timelineDataMock);
