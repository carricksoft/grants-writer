...
class GatherPeopleDivorceCertificateFirstPartyTimeLineDataRefsTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleDivorceCertificateFirstPartyTimeLineData = new GatherPeopleDivorceCertificateFirstPartyTimeLineDataImpl(
                timelineDataMock,
