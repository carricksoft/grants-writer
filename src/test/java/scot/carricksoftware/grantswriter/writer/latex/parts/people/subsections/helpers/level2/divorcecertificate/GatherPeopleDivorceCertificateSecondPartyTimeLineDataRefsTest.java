...
class GatherPeopleDivorceCertificateSecondPartyTimeLineDataRefsTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleDivorceCertificateSecondPartyTimeLineData = new GatherPeopleDivorceCertificateSecondPartyTimeLineDataImpl(
                timelineDataMock,
