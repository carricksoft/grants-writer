...
import scot.carricksoftware.grantswriter.writer.latex.parts.people.subsections.helpers.GatherPeopleDeathCertificateTimeLineData;
...
@Component
public class GatherPlacesDeathCertificateTimeLineDataImpl implements GatherPeopleDeathCertificateTimeLineData {
    private static final Logger logger = LogManager.getLogger(GatherPlacesDeathCertificateTimeLineDataImpl.class);
    ...
    public GatherPlacesDeathCertificateTimeLineDataImpl(DeathCertificateService deathCertificateService, GatherPeopleDeathCertificateDeceasedTimeLineData gatherPeopleDeathCertificateDeceasedTimeLineData, GatherPeopleDeathCertificateInformantTimeLineData gatherPeopleDeathCertificateInformantTimeLineData) {
