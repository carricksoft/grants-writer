...
class GatherDivorceCertificateSecondPartyTimeLineDataRefsTest {
    ...
    @BeforeEach
    void setUp() {
        gatherDivorceCertificateSecondPartyTimeLineData = new GatherDivorceCertificateSecondPartyTimeLineDataImpl(
                timelineDataMock,
