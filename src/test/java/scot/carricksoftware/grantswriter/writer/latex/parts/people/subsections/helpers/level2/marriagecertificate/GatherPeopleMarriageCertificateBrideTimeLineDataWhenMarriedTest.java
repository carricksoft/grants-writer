...
class GatherPeopleMarriageCertificateBrideTimeLineDataWhenMarriedTest {
    ...
    @BeforeEach
    void setUp() {
        gatherPeopleMarriageCertificateBrideTimeLineData = new GatherPeopleMarriageCertificateBrideTimeLineDataImpl(
    ...
    void whereMarriedTest() {
        ...
        String expected = "Married " + groom.toString() + " at " + whereMarried.toString();
